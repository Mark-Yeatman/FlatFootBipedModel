function [u,Farray,uArray] = KPBC_Combine(x)
...
global flowdata
    ...
    elseif strcmp(phase,'DSupp')
        ...
        F1 = -k*(E+GenE - Erefx-Eref)*Ldot1; %turn off front leg KPBC during DSupp
