...
flowdata.setPhases({'DSuppToeHeel'})
flowdata.setConfigs({})
flowdata.Phases.Flat.events = {};

%Control Functions
flowdata.Controls.Internal = {@Force_Control};
flowdata.Parameters.Cntr.k = 6867;
flowdata.Parameters.Cntr.d = 10000;
flowdata.Parameters.Cntr.L0 = 0.725;

%Extra Outputs
flowdata.PhaseOutputFuncs = {@Lambda, @event_data};
flowdata.StepOutputFuncs = {@StepLength, @Speed};
flowdata.WalkOutputFuncs = {@COMPos, @COPFootPos};
