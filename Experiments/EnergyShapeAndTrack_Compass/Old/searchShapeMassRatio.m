...
clear flowdata ratio_results_up ratio_results_down shape_mass_ratio_sweep_results
path(pathdef)
...
for k = 1:length(fnames)
    shape_mass_ratio_sweep_results.(fnames{k}) = ...
        [flip(ratio_results_down.(fnames{k})),ratio_results_center.(fnames{k}), ratio_results_up.(fnames{k})];
end
save Experiments\EnergyShapeAndTrack_Compass\Data\MassRatioSearch shape_mass_ratio_sweep_results -append