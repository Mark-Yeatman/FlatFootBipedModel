...
i = 1;
ratio = grid_results.physical_length_ratio.ratio{end-i};
StateStart = grid_results.physical_length_ratio.State{end-i}.extra;
xi = grid_results.physical_length_ratio.State{end-i}.xi;
grid_results.physical_length_ratio.Parameters{end-i}.Biped
Mh = 10;
Ms = 5;
Isz = 0;
a = 0.5;
...
disp(strcat("Expected stable speed: ", num2str(grid_results.physical_length_ratio.speed{end-i}) ))
